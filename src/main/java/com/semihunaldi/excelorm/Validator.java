...
class Validator {
    ...
    static void validate(Excel excelAnnotation) throws IllegalExcelArgumentException {
    ...
    static void validate(XSSFWorkbook xssfWorkbook) throws IllegalExcelArgumentException {
